...
public class EmotionFaceAronaNewController : EmotionFaceController
{
    ...
    // gameObject용 얼굴 바꾸기
    // [New] relax, listen, ><는 faceNormal을 비활성화하지 않고 오버레이로 활성화
    public void FaceChange(string faceName = "normal")
    {
        faceNormal.SetActive(true);  // faceNormal은 항상 활성화 유지
