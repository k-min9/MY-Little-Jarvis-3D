...
public static class ModelDataLocal
{
    ...
    {     
        ...
        //     new ModelFileInfo("Qwen3.6-27B-UD-IQ3_XXS.gguf", "https://huggingface.co/unsloth/Qwen3.6-27B-GGUF/resolve/main/Qwen3.6-27B-UD-IQ3_XXS.gguf?download=true", "12.4GB", 9348464640L),
        ...
        // }, "9.46GB"),
        // new ModelOption("qwen3.6-27b-UC", "Qwen3.6(27B-UC)", new List<ModelFileInfo> {
        //     new ModelFileInfo("Qwen3.6-27B-Uncensored-IQ3_XXS.gguf", "https://huggingface.co/unsloth/Qwen3.6-27B-GGUF/resolve/main/Qwen3.6-27B-Uncensored-IQ3_XXS.gguf?download=true", "12.4GB", 9348464640L),
        //     new ModelFileInfo("mmproj-Qwen3.6-BF16.gguf", "https://huggingface.co/unsloth/Qwen3.6-27B-GGUF/resolve/main/mmproj-BF16.gguf?download=true", "922MB", 788529152L)
        // }, "9.46GB"),
        ...
        new ModelOption("qwen3.5-9b-UC", "Qwen3.5(9B-UC)", new List<ModelFileInfo> {
            new ModelFileInfo("Qwen3.5-9B-Uncensored-HauhauCS-Aggressive-Q4_K_M.gguf", "https://huggingface.co/HauhauCS/Qwen3.5-9B-Uncensored-HauhauCS-Aggressive/resolve/main/Qwen3.5-9B-Uncensored-HauhauCS-Aggressive-Q4_K_M.gguf?download=true", "5.63GB", 9348464640L),
            new ModelFileInfo("mmproj-Qwen3.5-9B-Uncensored-HauhauCS-Aggressive-BF16.gguf", "https://huggingface.co/HauhauCS/Qwen3.5-9B-Uncensored-HauhauCS-Aggressive/resolve/main/mmproj-Qwen3.5-9B-Uncensored-HauhauCS-Aggressive-BF16.gguf?download=true", "922MB", 788529152L)
        }, "9.46GB"),
        new ModelOption("qwen3.6-35b-A3B", "Qwen3.6(35B-A3B)", new List<ModelFileInfo> {
            new ModelFileInfo("Qwen3.6-35B-A3B-UD-Q4_K_M.gguf", "https://huggingface.co/unsloth/Qwen3.6-35B-A3B-GGUF/resolve/main/Qwen3.6-35B-A3B-UD-Q4_K_M.gguf?download=true", "22.13GB", 23752005632L),
            new ModelFileInfo("mmproj-Qwen3.6-BF16.gguf", "https://huggingface.co/unsloth/Qwen3.6-35B-A3B-GGUF/resolve/main/mmproj-BF16.gguf?download=true", "903MB", 788529152L)
        }, "9.46GB"),
        new ModelOption("qwen3.6-35b-A3B-UC", "Qwen3.6(35B-A3B-UC)", new List<ModelFileInfo> {
            new ModelFileInfo("Qwen3.6-35B-A3B-Uncensored-HauhauCS-Aggressive-Q4_K_M.gguf", "https://huggingface.co/HauhauCS/Qwen3.6-35B-A3B-Uncensored-HauhauCS-Aggressive/resolve/main/Qwen3.6-35B-A3B-Uncensored-HauhauCS-Aggressive-Q4_K_M.gguf?download=true", "21.2GB", 23752005632L),
            new ModelFileInfo("mmproj-Qwen3.6-UC-BF16.gguf", "https://huggingface.co/HauhauCS/Qwen3.6-35B-A3B-Uncensored-HauhauCS-Aggressive/resolve/main/mmproj-Qwen3.6-35B-A3B-Uncensored-HauhauCS-Aggressive-f16.gguf?download=true", "903MB", 788529152L)
        }, "9.46GB"),
        new ModelOption("qwen3.6-27b", "Qwen3.6(27B)", new List<ModelFileInfo> {
            new ModelFileInfo("Qwen3.6-27B-UD-IQ3_XXS.gguf", "https://huggingface.co/unsloth/Qwen3.6-27B-GGUF/resolve/main/Qwen3.6-27B-UD-IQ3_XXS.gguf?download=true", "22.13GB", 23752005632L),
            new ModelFileInfo("mmproj-Qwen3.6D-BF16.gguf", "https://huggingface.co/unsloth/Qwen3.6-27B-GGUF/resolve/main/mmproj-BF16.gguf?download=true", "931MB", 788529152L)
        }, "9.46GB"),
        new ModelOption("qwen3.6-27b-UC", "Qwen3.6(27B-UC)", new List<ModelFileInfo> {
            new ModelFileInfo("Qwen3.6-27B-Uncensored-HauhauCS-Aggressive-IQ3_XS.gguf", "https://huggingface.co/HauhauCS/Qwen3.6-27B-Uncensored-HauhauCS-Aggressive/resolve/main/Qwen3.6-27B-Uncensored-HauhauCS-Aggressive-IQ3_XS.gguf?download=true", "12.0GB", 23752005632L),
            new ModelFileInfo("mmproj-Qwen3.6D-UC-BF16.gguf", "https://huggingface.co/HauhauCS/Qwen3.6-27B-Uncensored-HauhauCS-Aggressive/resolve/main/mmproj-Qwen3.6-27B-Uncensored-HauhauCS-Aggressive-f16.gguf?download=true", "928MB", 788529152L)
        }, "9.46GB"),
        new ModelOption("Gemma4-26b-A4B", "Gemma4(26B-A4B)", new List<ModelFileInfo> {
            ...
            new ModelFileInfo("mmproj-Gemma4-BF16.gguf", "https://huggingface.co/unsloth/gemma-4-26B-A4B-it-GGUF/resolve/main/mmproj-BF16.gguf?download=true", "922MB", 788529152L)
        }, "9.46GB"),
        new ModelOption("Gemma4-26b-UC", "Gemma4(26B-UC)", new List<ModelFileInfo> {
            ...
            new ModelFileInfo("mmproj-Gemma4-UC-BF16.gguf", "https://huggingface.co/unsloth/gemma-4-26B-A4B-it-GGUF/resolve/main/mmproj-BF16.gguf?download=true", "922MB", 788529152L)
        }, "9.46GB"),
        new ModelOption("Gemma4-E4B-UC", "Gemma4-E4B-UC", new List<ModelFileInfo> {
