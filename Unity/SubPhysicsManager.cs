...
좌우 이동 관리
*/
public class SubPhysicsManager : MonoBehaviour
{
    ...
    SubStatusManager subStatusManager;


    private void Start()
    {
        canvas = FindObjectOfType<Canvas>();
        subStatusManager = this.gameObject.GetComponent<SubStatusManager>();
    ...
    private void Update()
    {
        ...
        // || subStatusManager.isConversationing 
        || subStatusManager.isOptioning)
        {
            StopAllAnimations();
            return;
        }
